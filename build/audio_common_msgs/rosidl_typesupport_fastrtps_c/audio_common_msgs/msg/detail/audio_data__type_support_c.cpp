  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const audio_common_msgs__msg__AudioData * ros_message = static_cast<const audio_common_msgs__msg__AudioData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_audio_common_msgs__msg__AudioData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  audio_common_msgs__msg__AudioData * ros_message = static_cast<audio_common_msgs__msg__AudioData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_audio_common_msgs__msg__AudioData(cdr, ros_message);
}
