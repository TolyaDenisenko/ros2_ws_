  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = audio_common_msgs::msg::AudioDataStamped;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: audio
  audio_common_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.audio,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: audio
  current_alignment +=
    audio_common_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.audio, current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_audio_common_msgs
max_serialized_size_key_AudioDataStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: audio
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        audio_common_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_AudioData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
